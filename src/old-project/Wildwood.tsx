...
import { wildwoodStyles } from "./Wildwood.styles";
...
const Wildwood = React.forwardRef<HTMLDivElement, ComponentProps>((props, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={className}
      style={{ ...wildwoodStyles.root, ...style }}
      onClick={onClick}
    >
      <motion.div
        layoutId="X842TbKqq"
        style={wildwoodStyles.mainContent}
      >
        {/* Image Section with Special Border Radius */}
        <motion.div
          layoutId="d0lnn2IOI"
          style={wildwoodStyles.imageSection}
        >
          {/* Inner Background / Wrapper */}
          <motion.div
            layoutId="Ci583KWBr"
            style={wildwoodStyles.innerBackground}
          >
             {/* Award Badge (Hidden initially in source, kept structure) */}
            <motion.div
              layoutId="i6meRl82T"
              style={wildwoodStyles.awardBadge}
            >
               <img
                 src="https://framerusercontent.com/images/7noAoo6P7MRtarQDoGmrTFNn6xk.png?width=1153&height=591"
                 alt="Award Text"
                 style={{ height: "32px", width: "auto" }} // Approximate size
              />
               <img
            ...
            {/* Main Image */}
            <img
              src="https://framerusercontent.com/images/TDl283D6tMrfXZvR0NO92jO3K5g.jpg?width=1425&height=873"
              alt="Nike Tmall Wildwood"
              style={wildwoodStyles.mainImage}
            />

            {/* Icon 1 (Moon Big) */}
            <div style={wildwoodStyles.iconContainer1}>
            ...
            <div style={wildwoodStyles.iconContainer2}>
        ...
        {/* Text Row */}
        <div style={wildwoodStyles.textRow}>
           <h1 style={wildwoodStyles.title}>Nike Tmall Wildwood</h1>
           <h4 style={wildwoodStyles.subtitle}>UI / UX / Creative / Browsing Experience / 3D</h4>
        </div>
