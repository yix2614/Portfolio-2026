  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          ...tiktokSearchPageStyles.cardContainer,
      ...
      >
        ...
        <video
          ref={videoRef}
          style={tiktokSearchPageStyles.cardImage}
        ...
        {/* Bottom Info */}
        <div style={tiktokSearchPageStyles.cardBottom}>
          <div style={tiktokSearchPageStyles.cardTextCol}>
            <Text span style={tiktokSearchPageStyles.cardTitle}>
              TikTok.com
            </Text>
            <Text span style={tiktokSearchPageStyles.cardSubtitle}>
          ...
          <Button
            ...
            icon={
              ...
              >
                <path
                  d="M7 3.5C4.2 3.5 1.75 5.25 0.875 7C1.75 8.75 4.2 10.5 7 10.5C9.8 10.5 12.25 8.75 13.125 7C12.25 5.25 9.8 3.5 7 3.5ZM7 9.1C5.845 9.1 4.9 8.155 4.9 7C4.9 5.845 5.845 4.9 7 4.9C8.155 4.9 9.1 5.845 9.1 7C9.1 8.155 8.155 9.1 7 9.1ZM7 5.95C6.4225 5.95 5.95 6.4225 5.95 7C5.95 7.5775 6.4225 8.05 7 8.05C7.5775 8.05 6.4225 7.5775 5.95 7 5.95Z"
                  fill="var(--color-text-primary)"
                />
              </svg>
            }
            style={tiktokSearchPageStyles.cardButton}
            onClick={(e) => {
              e.stopPropagation(); // 阻止冒泡，虽然外层已经处理了跳转
              window.open("https://www.tiktok.com", "_blank");
            }}
          >
            <Text span style={tiktokSearchPageStyles.cardButtonText}>
              Explore
            </Text>
          </Button>
        </div>
...
const ContentSection = () => {
  return (
    <div
      style={tiktokSearchPageStyles.contentSection}
