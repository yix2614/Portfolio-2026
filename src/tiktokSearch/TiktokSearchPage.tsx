    ...
    <>
      ...
      <div style={tiktokSearchPageStyles.cardBottom}>
        <div style={tiktokSearchPageStyles.cardTextCol}>
          <Text span style={tiktokSearchPageStyles.cardTitle}>TikTok.com</Text>
          <Text span style={tiktokSearchPageStyles.cardSubtitle}>Short video / Discover / Web</Text>
        </div>
        ...
        >
          <Text span style={tiktokSearchPageStyles.cardButtonText}>Explore</Text>
        </Button>
      </div>
    </div>
    </>
...
const ContentSection = () => {
  return (
    <div style={tiktokSearchPageStyles.contentSection} className="content-section-container">
      <TiktokSearchContent />
    </div>
  );
};
